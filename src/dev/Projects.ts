  ...
  element.innerHTML = `
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          <div class="group bg-white dark:bg-slate-800 rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border border-slate-100 dark:border-slate-700 flex flex-col h-full">
            ...
            <div class="p-8 flex-1 flex flex-col">
              ...
              <div class="pt-6 border-t border-slate-100 dark:border-slate-700 flex justify-between items-center">
                ...
                <a href="${project.link}" target="_blank" rel="noopener noreferrer" class="text-primary hover:text-primary-dark transition-colors font-serif font-bold text-sm">
                  View
                </a>
              </div>
            </div>
      ...
      <div class="text-center">
          <a href="https://github.com/rochiv" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold font-serif text-lg hover:opacity-90 hover:scale-105 transition-all duration-300 shadow-lg">

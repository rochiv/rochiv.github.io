  ...
  element.innerHTML = `
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <ul class="space-y-4 font-serif text-slate-700 dark:text-slate-300">
        <li>
          <a href="https://github.com/rochiv/papers-to-code" target="_blank" class="text-primary dark:text-blue-400 hover:underline font-bold">papers-to-code</a>
        ...
        <li>
          <a href="https://github.com/rochiv" target="_blank" class="text-primary dark:text-blue-400 hover:underline font-bold">pdf-analysis-chatbot</a>
          <span class="text-sm"> - <!-- TODO: One-line description - is this project real? --></span>
        </li>
        <li>
          <a href="https://github.com/WVU-AIClub/LunarAutonomyChallenge" target="_blank" class="text-primary dark:text-blue-400 hover:underline font-bold">NASA Lunar Surface Operations</a>
        ...
        <li>
          <a href="https://github.com/rochiv" target="_blank" class="text-primary dark:text-blue-400 hover:underline font-bold">twitter-dashboard</a>
          <span class="text-sm"> - <!-- TODO: One-line description - is this project real? --></span>
        </li>
      </ul>
    </div>
